...
public static class Phonon3DPane
{
	public static void DrawPane()
	{
		EditorGUILayout.HelpBox("Phonon 3D does not have any global settings. Please configure Phonon 3D Source and Phonon 3D Listener objects using the Inspector window.", MessageType.Info);
	}
}